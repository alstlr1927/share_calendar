...
abstract class CustomModalRoute<T> extends TransitionRoute<T> with LocalHistoryRoute<T> {
  ...
  Widget _buildModalBarrier(BuildContext context) {
      ...
      final Animation<Color?> color = animation!.drive(
        ColorTween(
          begin: _kTransparent,
            ...
            curve: barrierCurve)), // changedInternalState is called if barrierCurve updates
      );
    ...
    barrier = IgnorePointer(
      ignoring: animation!.status ==
          ...
          animation!.status ==
              AnimationStatus.dismissed, // dismissed is possible when doing a manual pop gesture
      child: barrier,
    );
